            ...
            <?php foreach ($galeri as $key) { ?>
                <div class="col-lg-4 about_col about_col_left">
                    <div class="about_item">
                        <div class="about_item_image"><img src="<?= base_url('sampul/' . $key->sampul); ?>" alt="" style="width: 100%; height: 200px;"></div>
                        <div class="about_item_title"><a href="<?= base_url('home/detail_galeri/' . $key->id_galeri); ?>"><?= $key->nama_galeri; ?></a></div>

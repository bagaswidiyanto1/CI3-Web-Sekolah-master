...
<div class="home">
    <div class="home_slider_container">
        ...
        <div class="owl-carousel owl-theme home_slider">
            ...
            <!-- Home Slider Item -->
            <?php foreach ($slider_berita as $key) { ?>
                <div class="owl-item">
                    <div class="home_slider_background" style="background-image:url(<?= base_url('foto_berita/' . $key->gambar_berita); ?>)"></div>
                    <div class="home_slider_content">
                        <div class="container">
                            <div class="row">
                                <div class="col text-center">
                                    <div class="home_slider_title"><a href="<?= base_url('home/detail_berita/' . $key->slug_berita); ?>"><?= $key->judul_berita; ?></a></div>
                                    <div class="home_slider_subtitle"><?= substr(strip_tags($key->isi_berita), 0, 200); ?></div>

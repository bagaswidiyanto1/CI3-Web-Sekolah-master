        ...
        <div class="row team_row">
            ...
            <?php foreach ($guru as $key) { ?>
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="<?= base_url('foto_guru/' . $key->foto_guru); ?>" alt=""></div>
                        <div class="team_body">
                            <div class="team_subtitle"><?= $key->nip; ?></div>
                            <div class="team_title"><a href="#"><?= $key->nama_guru; ?></a></div>
                            <div class="team_subtitle"><?= $key->tempat_lahir; ?>, <?= $key->tgl_lahir; ?></div>
                            <div class="team_subtitle"><?= $key->nama_mapel; ?></div>
                            <div class="team_subtitle"><?= $key->pendidikan; ?></div>
